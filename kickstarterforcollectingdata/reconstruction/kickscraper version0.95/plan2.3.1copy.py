    ...
    try:
        ...
        for word in ccccc:
            if ' created' in word:
                ...
                creator_buildhistory_has_built_projects_number=creator_bio_info_sel.xpath('//*[@id="bio"]/div/div[2]/div[4]/a[1]/text()')
            if 'backed' in word:
                    #creator_buildhistory_has_backed_projects_number =word.strip()
                creator_buildhistory_has_backed_projects_number=word.strip()
            else:
                creator_buildhistory_has_backed_projects_number=creator_bio_info_sel.xpath('//*[@id="bio"]/div/div[2]/div[4]/a[2]/text()')
