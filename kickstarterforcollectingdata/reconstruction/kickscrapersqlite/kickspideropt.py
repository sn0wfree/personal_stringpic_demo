...
def webscraper_successed(someurl,a,the_page):
    ...
    try:
        ...
        projectitem[ 'Goal']= goal_seek
        projectitem[ 'pledged_amount']=pledged_amount_str
        #print 'pledged', pledged
        projectitem[ 'data_percent_rasied']= 0
        projectitem[ 'currency']= 0
        projectitem[ 'hours_left']= 0
        #print 'day_left', day_left

        projectitem[ 'description']=''.join(description).strip('\n')
        projectitem[ 'creator_short_name']= creator_short_name_s
        projectitem[ 'creator_personal_url']= creator_personal_url_s
        projectitem[ 'creator_bio_info_url']=''.join(creator_bio_info_url)
        projectitem[ 'creator_full_name']=''.join(creator_full_name).strip()
    ...
    return projectitem, rewards , project_ID , projectitem['project_state']
