...
#read projetc urls
file_unclear_file = open('data/middle60project/middle60project.txt','r+')
file_unclear =file_unclear_file.readlines()
file_unclear_file.close()
collected_file = open('data/middle60project/collected.txt','r+')
collected =collected_file.readlines()
...
def collectingdate(someurl):
    ...
    if someurl !='':
        ...
        if len(total_item)>100:
            ...
            funcforkick.writeacsvprocess('data/test/project_data.csv',item_headers,total_item)
            funcforkick.writeacsvprocess('data/test/rewards_backers_distribution.csv',rewards_headers,total_rewards_backers_distribution)
            funcforkick.writeacsvprocess('data/test/rewards_pledge_limit.csv',rewards_headers,total_rewards_pledge_limit)
            funcforkick.writeacsvprocess('data/test/rewards_pledged_amount.csv',rewards_headers,total_rewards_pledged_amount)
            #reset list
            total_item=[]
            total_rewards_backers_distribution=[]
            total_rewards_pledge_limit=[]
