...
projectdata_create_table = "create table projectdata (creator_personal_url text, creator_buildhistory_has_backed_projects_number text, Goal text, creator_buildhistory_has_built_projects_number text, creator_bio_info_url text, creator_Facebook_url text, currency text, duration text, Project_ID text, location_ID text, state_changed_at text, description text, category text, project_state text, has_a_video text, comments_count test, updates_number test, project_name text, data_percent_rasied text, hours_left text, pledged_amount text, creator_short_name text, creator_friends__facebook_number text, created_at text, Deadline int, backers_count int, creator_full_name text)"
#if not exist
#cur.execute(projectdata_create_table )

def addvalue(cur,projectdata_add):
    cur.executemany('insert into projectdata values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', projectdata_add)
    projectdata.commit()
...
items_headers =['creator_personal_url', 'creator_buildhistory_has_backed_projects_number', 'Goal', 'creator_buildhistory_has_built_projects_number', 'creator_bio_info_url', 'creator_Facebook_url', 'currency', 'duration', 'Project_ID', 'location_ID', 'state_changed_at', 'description', 'category', 'project_state', 'has_a_video', 'comments_count', 'updates_number', 'project_name', 'data_percent_rasied', 'hours_left', 'pledged_amount', 'creator_short_name', 'creator_friends__facebook_number', 'created_at', 'Deadline', 'backers_count', 'creator_full_name']
